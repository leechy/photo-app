...
const PhraseEditPage: React.FC = () => {
  ...
  return (
    <AppPage
      title={item?.id || intl.formatMessage({ id: 'private.phrases.new.title' })}
      showHeading={true}
      backHref="/settings/translations/phrases"
      buttons={
      ...
      <IonList>
        ...
        <IonItem>
          <IonLabel>
            ...
            <p>
              <FormattedMessage id="fields.description.phrase.description" defaultMessage="Where the phrase is used" />
            </p>
          </IonLabel>
          <IonInput
            className="text-input"
